...
Private WithEvents p_oCOSales As clsCPChargeInvoice
Attribute p_oCOSales.VB_VarHelpID = -1
...
Property Set Client(Value As clsARClient)
   Set p_oClient = Value
End Property

Property Set Sales(Value As clsCPChargeInvoice)
   Set p_oCOSales = Value
End Property
